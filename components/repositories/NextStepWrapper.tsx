...
const CustomCard = ({
  ...
  return (
    <div
      className="bg-white rounded-lg shadow-lg border border-slate-200 p-4 sm:p-6 w-full max-w-sm"
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-2">
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0 w-full sm:w-auto">
            {currentStep > 0 && (
              <button
                onClick={prevStep}
                className="px-2 sm:px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md transition-colors cursor-pointer text-xs sm:text-sm font-medium whitespace-nowrap"
              >
                Précédent
              </button>
            )}
            {currentStep < totalSteps - 1 ? (
              <button
                onClick={nextStep}
                className="px-2 sm:px-3 py-1.5 cursor-pointer bg-violet-600 hover:bg-violet-700 text-white rounded-md transition-colors text-xs sm:text-sm font-medium whitespace-nowrap"
              >
                Suivant
              </button>
            ) : (
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0 justify-end">
            ...
            <button
              onClick={handleSkipTour}
              className="px-2 sm:px-3 py-1.5 bg-white border border-slate-300 hover:bg-slate-50 text-slate-900 hover:text-slate-700 cursor-pointer rounded-md transition-colors text-xs sm:text-sm font-medium whitespace-nowrap"
            >
              Passer
            </button>
          </div>
